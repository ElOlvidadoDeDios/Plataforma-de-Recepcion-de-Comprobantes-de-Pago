...
const Welcome: React.FC = () => {
  ...
  const PrivilegedUserContent = () => {
    const availableOptions = [
      ...
      ...(permissions.canAccessConsultaCuotas() ? [{ title: 'Consulta de Cuotas', description: 'Revisa el estado de las cuotas', onClick: () => navigate('/consultas-cuotas'), icon: '📊' }] : []),
      ...
      ...(permissions.canAccessRegistroClientes() ? [{ title: 'Registro de Clientes', description: 'Registra y gestiona información de clientes', onClick: () => navigate('/registro-clientes'), icon: '👤' }] : []),
