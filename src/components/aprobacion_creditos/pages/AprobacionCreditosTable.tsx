...
const AprobacionCreditosTable: React.FC = () => {
        ...
        <div className="flex flex-col items-center justify-center h-full bg-red-50 rounded-lg p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              Este módulo está disponible solo para: Super Admin y Administrador.
            </p>
          </div>
        </div>
      </Layout>
  ...
  return (
    <Layout title="APROBACIÓN DE CRÉDITOS" showBackButton={true}>
      <div className="h-full flex flex-col space-y-6">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-500 p-4 sm:p-6 rounded-lg shadow-lg text-white">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <h2 className="text-xl sm:text-2xl font-bold">APROBACIÓN DE CRÉDITOS</h2>
          ...
          {isLoading ? (
            ...
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                ...
                <p className="text-gray-500">No hay solicitudes de crédito para aprobar</p>
              </div>
            </div>
          ) : (
