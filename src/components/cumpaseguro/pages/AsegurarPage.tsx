    ...
    <Layout title="Mi CumpaSeguro" showBackButton={true}>
      <div className="w-full min-w-0 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center gap-3 mb-4">
          ...
          {/* Botón Gestión de Pólizas - visible cuando tiene acceso al módulo */}
          {onVerPolizas && (
            <button
              onClick={onVerPolizas}
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-purple-500 rounded-lg hover:bg-purple-600 transition-colors shadow-sm hover:shadow-md"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
