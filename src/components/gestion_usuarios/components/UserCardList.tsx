              ...
              <div className="p-4 w-full">
                ...
                <div className="w-full space-y-3 pt-4 border-t border-gray-200">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-1 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2 border bg-amber-50 text-amber-700 hover:bg-amber-100 border-amber-200"
                  >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
