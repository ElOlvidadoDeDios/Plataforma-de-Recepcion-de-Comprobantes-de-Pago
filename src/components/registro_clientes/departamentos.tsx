...
// Estructura completa de provincias y distritos para todos los departamentos
const locationData: { [key: string]: { provincias: string[]; distritos: { [key: string]: string[] } } } = {
    AMAZONAS: {
        ...
        distritos: {
            ...
            CONDORCANQUI: ['SANTA MARIA DE NIEVA', 'EL CENEPA', 'RIO SANTIAGO'],
            LUYA: ['LAMUD', 'CAMPORREDONDO', 'COCABAMBA', 'COLCAMAR', 'CONILA', 'INGUILPATA', 'LONGUITA', 'LONYA CHICO', 'LONYA GRANDE', 'MARIA', 'OCALLI', 'OCUMAL', 'PISUQUIA', 'PROVIDENCIA', 'SAN CRISTOBAL', 'SAN FRANCISCO DEL YESO', 'SAN JERONIMO', 'SAN JUAN DE LOPECANCHA', 'SANTA CATALINA', 'SANTO TOMAS', 'TINGO', 'TRITA'],
    ...
    ANCASH: {
        provincias: ['HUARAZ', 'AIJA', 'ANTONIO RAYMONDI', 'ASUNCION', 'BOLOGNESI', 'CARHUAZ', 'CARLOS FERMIN FITZCARRALD', 'CASMA', 'CORONGO', 'HUARI', 'HUARMEY', 'HUAYLAS', 'MARISCAL LUZURIAGA', 'OCROS', 'PALLASCA', 'POMABAMBA', 'RECUAY', 'SANTA', 'SIHUAS', 'YUNGAY'],
        distritos: {
            ...
            BOLOGNESI: ['CHIQUIAN', 'ABELARDO PARDO LEZAMETA', 'ANTONIO RAYMONDI', 'AQUIA', 'CAJACAY', 'CANIS', 'COLQUIOC', 'HUALLANCA', 'HUASTA', 'HUAYLLACAYAN', 'LA PRIMAVERA', 'MANGAS', 'PACLLОН', 'SAN MIGUEL DE CORPANQUI', 'TICLLOS'],
    ...
    AYACUCHO: {
        ...
        distritos: {
            ...
            LUCANAS: ['PUQUIO', 'AUCARA', 'CABANA', 'CARMEN SALCEDO', 'CHAVIÑA', 'CHIPAO', 'HUAC-HUAS', 'LARAMATE', 'LEONCIO PRADO', 'LLAUTA', 'LUCANAS', 'OCAÑA', 'OTOCA', 'SAISA', 'SAN CRISTOBAL', 'SAN JOSE DE USHUA', 'SAN PEDRO', 'SAN PEDRO DE PALCO', 'SANCOS', 'SANTA ANA DE HUAYCAHUACHO', 'SANTA LUCIA'],
            ...
            'VICTOR FAJARDO': ['HUANCAPI', 'ALCAMENCA', 'APONGO', 'ASQUIPATA', 'CANARIA', 'CAYARA', 'COLCA', 'HUAMANQUIQUIA', 'HUANCARAYLLA', 'HUALLA', 'SARHUA', 'VILCANCHOS'],
            'VILCAS HUAMAN': ['VILCAS HUAMAN', 'ACCOMARCA', 'CARHUANCA', 'CONCEPCION', 'HUAMBALPA', 'INDEPENDENCIA', 'SAURAMA', 'VISCHONGO']
        }
    },
    CAJAMARCA: {
        provincias: ['CAJAMARCA', 'CAJABAMBA', 'CELENDIN', 'CHOTA', 'CONTUMAZÁ', 'CUTERVO', 'HUALGAYOC', 'JAEN', 'SAN IGNACIO', 'SAN MARCOS', 'SAN MIGUEL', 'SAN PABLO', 'SANTA CRUZ'],
        distritos: {
            ...
            CONTUMAZÁ: ['CONTUMAZA', 'CHILETE', 'CUPISNIQUE', 'GUZMANGO', 'SAN BENITO', 'SANTA CRUZ DE TOLED', 'TANTARICA', 'YONAN'],
    ...
    JUNIN: {
        ...
        distritos: {
            ...
            CHUPACA: ['CHUPACA', 'AHUAC', 'CHONGOS BAJO', 'HUACHAC', 'CHAMISERIA', 'SAN JUAN DE YSCOS', 'SAN JUAN DE JARPA', 'TRES DE DICIEMBRE', 'YANACANCHA']
        }
    },
    'LA LIBERTAD': {
...
export { departamentoOptions, locationData };